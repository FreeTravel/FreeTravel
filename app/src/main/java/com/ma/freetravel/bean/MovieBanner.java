...
public class MovieBanner {
    ...
    public  void parseData(JSONObject jsonObject){
        try {
            FilmAlbumID=jsonObject.getInt("FilmAlbumID");
            ManagerID=jsonObject.getInt("ManagerID");
            Title= jsonObject.getString("Title");
            Description= jsonObject.getString("Description");
            AddTime= jsonObject.getString("AddTime");
            ThePhoto= jsonObject.getString("ThePhoto");
            InfoIDS= jsonObject.getString("InfoIDS");
            LabelIDS= jsonObject.getString("LabelIDS");
            IsUsed=jsonObject.getBoolean("IsUsed");
